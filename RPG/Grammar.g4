...
functionStatement	: function SEMI;

function			: localFunction | globalFunction;
globalFunction		: functionName arguments (DOT functionName arguments)*;
localFunction		: varName DOT functionName arguments(DOT functionName arguments)*;
